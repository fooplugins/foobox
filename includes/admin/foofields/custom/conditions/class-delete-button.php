...
if ( ! class_exists( __NAMESPACE__ . '\DeleteButton' ) ) {
	...
	class DeleteButton extends Field {
		...
		function __construct( $container, $type, $field_config ) {
			...
			$this->delete_title = isset( $field_config['delete_title'] ) ? $field_config['delete_title'] : __( 'Delete Group', $container->manager->text_domain );
		}
		...
		function render_input( $override_attributes = false ) {
			self::render_html_tag( 'a', array(
				'class' => 'foofields-conditions-button foofields-conditions-delete',
				'href' => '#delete',
