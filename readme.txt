...
* Fix : fixed Pinterest sharing not working in some cases.
[//]: # fs_premium_only_end

= 2.7.20 =
* Updated 5 Sep 2021
[//]: # fs_premium_only_begin
* Fix : fixed REL Grouping not being output if set to "foobox"
[//]: # fs_premium_only_end
...
[//]: # fs_premium_only_begin
* Fix : check for null title when sharing to networks
[//]: # fs_premium_only_end
...
= 2.7.11 =
[//]: # fs_premium_only_begin
*	Fix : fix for Fotomoto integration
[//]: # fs_premium_only_end
...
= 2.7.8 =
[//]: # fs_premium_only_begin
*	Fix : Fixed share on pinterest when using bitly
[//]: # fs_premium_only_end
...
= 2.7.7 =
[//]: # fs_premium_only_begin
* Fix : Major bug with lightbox not opening in v2.7.6. Please update!
[//]: # fs_premium_only_end
